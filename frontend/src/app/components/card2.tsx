...
const InfoCard = ({ icon: Icon, title, subtitle, onClick }: InfoCardProps) => (
  <div
    className="w-full 2xl:w-75 2xl:h-35 cursor-pointer bg-white rounded-lg flex p-4 overflow-hidden border-gray-200 border-1.5 shadow-sm hover:bg-gray-400 hover:shadow-xl transition-all duration-200 ease-in-out"
    onClick={onClick}
  >
